...
/**
 * Find the range(s) corresponding to the given {@link @annotator/selector#RangeSelector}.
 *
 ...
 *
 * @example
 * By using a matcher for {@link @annotator/selector#TextQuoteSelector}s, one
 ...
 * @annotator/selector#Matcher} function that applies it to a given {@link https://developer.mozilla.org/en-US/docs/Web/API/Range
 * | Range}
 *
 * @public
 */
