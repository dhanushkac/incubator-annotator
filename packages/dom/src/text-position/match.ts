...
/**
 * Find the range of text corresponding to the given {@link @annotator/selector#TextPositionSelector}.
 *
 * @remarks
 ...
 * @annotator/selector#TextQuoteSelector}, a TextPositionSelector cannot have
 * multiple matches).
 *
 * @example
 * ```
 ...
 * ```
 *
 * @param selector - The {@link @annotator/selector#TextPositionSelector} to be
 * anchored
 * @returns A {@link @annotator/selector#Matcher} function that applies
