...
/**
 * Find occurrences in a text matching the given {@link @annotator/selector#TextQuoteSelector}.
 *
 * @remarks
 ...
 * ```
 *
 * @param selector - The {@link @annotator/selector#TextQuoteSelector} to be
 * anchored
