...
/**
 * Find the elements corresponding to the given {@link @annotator/selector#CssSelector}.
 *
 * @remarks
 ...
 * @annotator/selector#Selector.refinedBy | refine} this CssSelector.
 *
 * @param selector - The {@link @annotator/selector#CssSelector} to be anchored
